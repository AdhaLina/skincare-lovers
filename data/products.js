...
const PRODUCTS = [
  ...
  },
  {
    ...
    name: "REJURAN Moisture Treatment Mask c-PDRN (5-Pack)",
    brand: "REJURAN",
    category: "mask",
    price: "$30",
    rating: 4.7,
    ...
    tag: "Daily Essential",
    skinTypes: ["all", "dry", "sensitive"],
    blurb: "A c-PDRN hydrating sheet mask that repairs the skin barrier and locks in deep moisture.",
    pros: ["Deep hydration", "Barrier repair", "c-PDRN + PDRx"],
    link: "https://amzn.to/4hccJxF",
  },
  {
    id: "sleeping-mask",
